        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li id = "category-nav">
                        <a href="<?php echo base_url();?>dashboard/category"><i class="fa fa-fw fa-file"></i> Categories</a>
                    </li>

                    <li id = "portfolio-nav">
                        <a href="<?php echo base_url();?>dashboard/portfolio"><i class="fa fa-fw fa-file"></i> Portfolios</a>
                    </li>
